---
title: "Reports and KPI Dashboard: Financial Analytics"
...
|---|---|---|
| Period | `hoy` (today), `semana` (last 7 days), `mes` (last 30 days) | `hoy` |
| Status | `Todos`, `Recibido`, `Preparando`, `Listo`, `Entregado` | `Todos` |
...
**`periodo` values:** `hoy`, `semana`, `mes` (defaults to last 30 days if omitted)

**`estado` values:** `recibido`, `preparando`, `listo`, `entregado` (omit or pass `Todos` for no status filter)
