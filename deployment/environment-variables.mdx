---
title: "Environment Variables for Tradiciones y Sabores"
...
<ParamField body="VITE_API_KEY" type="string">
  API key for authenticating with the backend. Refer to the backend `.env` for the matching `API_KEY` value.
...
# API Key del backend (ver variable API_KEY en el .env del backend de los compañeros)
